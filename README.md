Hire is YII 2 RESTful API for the todo app done for the react app on my other repository named todoWithRedux.

The table (PostgreSQL) for which is API is:
...
in config (web.php) :
        'urlManager' => [
            ...
            'controller' => ['todoitem', 'user', 'products', 'categories'],
            'extraPatterns' => ['GET search' => 'search'],
            'pluralize' => false],
            // ['class' => 'yii\rest\UrlRule', 'controller' => 'todoitem'],
            ],
        ],
    
<p align="center">
    <a href="https://github.com/yiisoft" target="_blank">
        <img src="https://avatars0.githubtodoitemcontent.com/u/993323" height="100px">
    </a>
...
The template contains the basic features including todoitem login/logout and a contact page.
...
tests are for testing todoitem interaction. Acceptance tests are disabled by default as they require additional setup since
